# 1. Fitting a parallel slopes linear regression

# Fit a linear regr'n of price_twd_msq vs. n_conveience
...
mdl_price_vs_age <- lm(formula = price_twd_msq ~ house_age_years + 0, data=taiwan_real_estate)
...
# 3. Visualizing each explanatory variable
...
# 5. Predicting with a parallel slopes model
...
# 6. Manually calculating predictions
...
# 7. Comparing coefficients of determination
...
# 8. Comparing residual standard error
